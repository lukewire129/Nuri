...
- All CPU phases are fast but presentation is visibly late: correlate the Duxel log timestamps with PresentMon or PIX. Nuri cannot observe GPU completion through the current Duxel `0.2.12-preview` public API.
