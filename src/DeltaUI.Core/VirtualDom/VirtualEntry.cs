...
namespace DeltaUI.Core.VirtualDom
{
    public sealed class VirtualEntry
    {
        ...
        public VirtualEntry(
            ...
            IEnumerable<KeyValuePair<string, Delegate>>? events = null,
            ...
            IEnumerable<VirtualEntry>? children = null)
        {
            ...
            Events = ToDictionary(events ?? Enumerable.Empty<KeyValuePair<string, Delegate>>());
        ...
        public IReadOnlyDictionary<string, Delegate> Events { get; }
