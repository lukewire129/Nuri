...
namespace Nuri.WPF
{
    internal sealed class WpfDistributedStackPanel : Panel
    {
        ...
        public WpfDistributedStackPanel(Orientation orientation)
        {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if (InternalChildren.Count > 1)
                desiredMain += Spacing * (InternalChildren.Count - 1);
