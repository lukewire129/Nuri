        ...
        return
            Div(
                ...
                Div(
                    ...
                    Div(
                        DivTypes.Row,
                        Button(detailVisible ? "Unmount detail" : "Mount detail", () => setDetailVisible(current => !current))
                            .Size(150, 38),
                    ...
                    Div(
                        ...
                        detailVisible ? new DetailComponent().Key("diagnostics-detail") : Text("Detail component is unmounted.").FontColor("#94A3B8")
                    )
                    .Spacing(12)
                    .Margin(top: 18),
...
internal sealed class DetailComponent : Component
{
    public override IElement Render()
    {
        ...
        return
            Div(
                Text("Keyed detail component")
                    .FontWeight(FontWeightValue.Bold)
                    .FontColor("#F8FAFC"),
                Text($"Mounted at: {mountedAt}")
                    .FontColor("#CBD5E1"),
